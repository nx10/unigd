...
namespace unigd
{
    namespace dc
    {
        ...
        void Text::visit(draw_call_visitor *t_visitor) const
        {
            t_visitor->visit(this);
        }

        void Circle::visit(draw_call_visitor *t_visitor) const
        {
            t_visitor->visit(this);
        }

        void Line::visit(draw_call_visitor *t_visitor) const
        {
            t_visitor->visit(this);
        }

        void Rect::visit(draw_call_visitor *t_visitor) const
        {
            t_visitor->visit(this);
        }

        void Polyline::visit(draw_call_visitor *t_visitor) const
        {
            t_visitor->visit(this);
        }

        void Polygon::visit(draw_call_visitor *t_visitor) const
        {
            t_visitor->visit(this);
        }

        void Path::visit(draw_call_visitor *t_visitor) const
        {
            t_visitor->visit(this);
        }

        void Raster::visit(draw_call_visitor *t_visitor) const
        {
            t_visitor->visit(this);
        }
